...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      ★★ 예를들어, app/dashboard/invoice/Layout.tsx가 있다고 치면, app/dashboard/invoice/Layout.tsx와 위치가 같거나, 하위(상속받는)에 있는 page.tsx(예를들어 app/dashboard/invoice/create/page.tsx) 세그먼트는 app/dashboard/invoice/Layout.tsx에 children을 전달함
      ...
      즉, 보다 하위 Layout.tsx에는 children값을 넘겨주지 않지만 보다 상위 Layout.tsx에는 children 값을 넘겨줌 */}
